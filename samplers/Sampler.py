...
import numpy as np
from samplers.CarActions import CarActions as ca
import os
...
class Sampler:
    ...
    @classmethod
    def collectSamples(cls, requested_no_samples: int):
        ...
        while actions_counter < no_samples:
            x = np.zeros(shape=(no_samples + 1, 64, 64, 3))
    ...
    @classmethod
    def sample(cls, NUMBER_OF_SAMPLES):
        cls.collectSamples(NUMBER_OF_SAMPLES)
